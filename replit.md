...
- June 25, 2025. User prefers actual Qwen model over simulated responses. Reconfigured ProcessGPT to connect to real Android emulator at http://10.0.2.2:8080. Created minimal Python bridge (qwen-bridge-minimal.py) for Termux deployment to connect actual Qwen2.5-1.5B model in AI Edge Gallery with ProcessGPT for authentic local AI inference on manufacturing data
