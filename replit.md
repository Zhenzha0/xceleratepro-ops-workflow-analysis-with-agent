...
- June 25, 2025. Implemented TinyLlama Local AI integration: Downloaded TinyLlama-1.1B-Chat model (1.4GB), created local inference server on port 8080, added TinyLlama service to ProcessGPT with intelligent manufacturing responses. User can now switch between OpenAI and local TinyLlama model for complete data privacy while maintaining all 25 ProcessGPT analysis capabilities with authentic manufacturing insights
